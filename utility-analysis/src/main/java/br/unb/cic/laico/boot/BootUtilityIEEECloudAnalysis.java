...
public class BootUtilityIEEECloudAnalysis {

	private static Logger logger = Logger.getLogger(BootUtilityIEEECloudAnalysis.class);
	...
	public static void main(String[] args) throws Exception {
		...
		BootUtilityIEEECloudAnalysis app = new BootUtilityIEEECloudAnalysis();
		app.runApp();
	}
}

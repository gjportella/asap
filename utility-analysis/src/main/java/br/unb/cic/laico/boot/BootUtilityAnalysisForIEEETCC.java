...
public class BootUtilityAnalysisForIEEETCC {

	private static Logger logger = Logger.getLogger(BootUtilityAnalysisForIEEETCC.class);
	...
	public void runApp() {
		...
		String outputFileName = basePath + "UtilityAnalysisForIEEETCC.txt";
	...
	public static void main(String[] args) throws Exception {
		...
		BootUtilityAnalysisForIEEETCC app = new BootUtilityAnalysisForIEEETCC();
		app.runApp();
	}
}

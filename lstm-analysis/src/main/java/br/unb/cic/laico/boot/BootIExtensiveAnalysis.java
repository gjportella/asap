...
public class BootIExtensiveAnalysis implements BootAnalysis {

	private static Logger logger = Logger.getLogger(BootIExtensiveAnalysis.class);
	...
	private LSTMConfiguration getLSTMConfiguration(String yearMonth, String instanceType, int numberOfFeatures,
		...
		config.setInputCsvPath("src/main/resources/extensive-analysis/" + instanceType + "/us-east-1/");
	...
	public void runAnalysis() throws Exception { 
		...
		CsvWrapperWriter csv = new CsvWrapperWriter("src/main/resources/extensive-analysis/ExtensiveAnalysis.txt");
		try {
			csv.openFile();
	...
	public static void main(String[] args) throws Exception {
		...
		BootAnalysis analysis = new BootIExtensiveAnalysis();
